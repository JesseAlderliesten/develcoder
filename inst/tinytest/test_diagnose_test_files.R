...
expect_identical(
  ...
  list(pkg = pkg_name, path = path_testdir, pattern = "^test_|^test-",
       ignore_case = TRUE, status_testdir = "missing", status_test_files = "missing",
...
expect_identical(
  diagnose_test_files(path = path_testdir),
  list(pkg = pkg_name, path = path_testdir, pattern = "^test_|^test-",
       ignore_case = TRUE, status_testdir = "present", status_test_files = "missing",
       test_files = character(0), ignored_files = character(0))
)
...
expect_identical(
  ...
  list(pkg = pkg_name, path = path_testdir, pattern = "^misc_",
       ignore_case = TRUE, status_testdir = "present", status_test_files = "fine",
       test_files = "misc_file.R", ignored_files = character(0))
)

##### 'ignore_case' is respected #####
expect_identical(
  diagnose_test_files(path = path_testdir, pattern = "^MIsc_", ignore_case = TRUE),
  list(pkg = pkg_name, path = path_testdir, pattern = "^MIsc_",
       ignore_case = TRUE, status_testdir = "present", status_test_files = "fine",
       test_files = "misc_file.R", ignored_files = character(0))
)
...
expect_identical(
  diagnose_test_files(path = path_testdir, pattern = "^MIsc_", ignore_case = FALSE),
  list(pkg = pkg_name, path = path_testdir, pattern = "^MIsc_",
       ignore_case = FALSE, status_testdir = "present", status_test_files = "missing",
       test_files = character(0), ignored_files = "misc_file.R")
)
...
expect_identical(
  ...
  list(pkg = pkg_name, path = path_testdir, pattern = "^test_|^test-",
       ignore_case = TRUE, status_testdir = "present", status_test_files = "wrong",

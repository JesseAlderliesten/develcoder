...
`D:\Userdata\<username>\Documents\.Rprofile`, see `help("Startup")` for details),
...
also be used as help-page such that `help("<pkgname>")` produces a description
of the package with an overview of its functions.
...
`usethis::use_package()` uses the currently installed

...
### Package overview
`R/<pkg>-package.R` is used by `usethis` to list imported functions and can
also be used as help-page such that `help("<pkg>")` produces a description
...
- Manually update `README.Rmd`
  ...
  - Add a badge with the version number by including the following code in the
    `README.Rmd` file (replace `<pkg>` with the actual package name; the

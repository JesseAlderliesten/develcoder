...
Bookmarks: `R` > `CreatePkgs` > `RMarkdown` on using RMarkdown to style
vignettes.
...
If no vignettes are visible, run `pkgdown::build_article()`, which possibly
...
see https://pkgdown.r-lib.org/reference/build_reference.html and the example at
...
See alsoe https://cran.r-project.org/web/packages/policies.html and

...
- When adding mew function arguments to an existing function, it is best
  ...
  will work the same as before the change, even if they rely on positional
...
number in the commit title makes it easier to find changes back later on (the
pull request can have a description of the changes, i.e., the updated section of
the `NEWS` file).
